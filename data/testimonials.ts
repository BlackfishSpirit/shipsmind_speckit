export const testimonials = [
  {
    id: "retail-1",
    quote: "We went from spending 15 hours a week on inventory management to just 2 hours. The AI system caught stockouts before they happened and increased our sales by 28%.",
  ...
  {
    id: "legal-1", 
    quote: "Document review that used to take me 8 hours now takes 45 minutes. I can focus on actual legal work instead of paperwork, and my billable hours increased significantly.",
    author: "Michael Chen",
  ...
  {
    id: "trades-1",
    quote: "The AI phone system captures emergency calls 24/7. We're booking 40% more jobs and customers love the instant response. It paid for itself in 3 weeks.",
